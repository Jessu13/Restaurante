    ...
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
        ...
        <div className='flex items-center'>
            ...
            <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>
                SPJ <span className='font-bold'> Comidas </span>
            </h1>

            <div className='hidden lg:flex items-center bg-gray-200 rounded-full p-1 text-[14px]'>
                <p className='bg-black text-white rounded-full p-2'>Entregas</p>
                <p className='p-2'>Recoge in site</p>
            </div>
        </div>
        ...
        <div className='bg-gray-200 rounded-full flex items-center px-2 w-[200px] sm:w-[400px] lg:w-[500px]'>
            ...
            <input className='bg-transparent p-2 w-full focus:outline-none' type="text" placeholder='Buscar Comida'/>
        </div>
